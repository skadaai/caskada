...
async def run_text_to_sql(natural_query, db_path=DB_FILE, max_debug_retries=3):
    ...
    await flow.run(shared) # Let errors inside the loop be handled by the flow logic
...
if __name__ == "__main__":
    ...
    import asyncio
    asyncio.run(run_text_to_sql(query)) 