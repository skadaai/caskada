...
## BrainyFlow Agent with A2A Protocol ([python-a2a](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-a2a))
...
# BrainyFlow Agent with A2A Protocol
...
## BrainyFlow Async Basic Example ([python-async-basic](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-async-basic))
...
## BrainyFlow batch Flow Example ([python-batch-flow](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-batch-flow))
...
## BrainyFlow batch Node Example ([python-batch-node](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-batch-node))
...
## Simple BrainyFlow Chat ([python-chat](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-chat))
A basic chat application using BrainyFlow with OpenAI's GPT-4o model.<details>
<summary><strong>Details</strong></summary>


#  Simple BrainyFlow Chat
...
## BrainyFlow Chat with Memory ([python-chat-memory](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-chat-memory))
...
## BrainyFlow Communication Example ([python-communication](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-communication))
...
## BrainyFlow Web Human-in-the-Loop (HITL) Feedback Service ([python-fastapi-hitl](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-fastapi-hitl))
...
# BrainyFlow Web Human-in-the-Loop (HITL) Feedback Service
...
## BrainyFlow MCP Demo ([python-mcp](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-mcp))
...
## BrainyFlow Nested Batch Flow Example ([python-nested-batch](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-nested-batch))
...
## BrainyFlow Summarize ([python-node](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-node))
...
## BrainyFlow Streamlit Human-in-the-Loop (HITL) Application ([python-streamlit-hitl](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-streamlit-hitl))
...
## BrainyFlow Tool: PDF Vision ([python-tool-pdf-vision](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-tool-pdf-vision))
...
## BrainyFlow Voice Chat ([python-voice-chat](https:/github.com/zvictor/brainyflow/tree/main/cookbook/python-voice-chat))
